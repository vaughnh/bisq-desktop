package bisq.gui.main.market.offerbook;
...
public class OfferBookChartViewModelTest {
    ...
    public void testMaxCharactersForBuyPrice() {
        ...
        offerBookListItems.addAll(make(OfferBookListItemMaker.btcItem.but(MakeItEasy.with(OfferBookListItemMaker.price, 94016475L))));
        assertEquals(9, model.maxPlacesForBuyPrice.intValue());
        offerBookListItems.addAll(make(OfferBookListItemMaker.btcItem.but(MakeItEasy.with(OfferBookListItemMaker.price, 101016475L))));
    ...
    public void testMaxCharactersForBuyVolume() {
        ...
        offerBookListItems.addAll(make(OfferBookListItemMaker.btcItem.but(MakeItEasy.with(OfferBookListItemMaker.amount, 100000000L))));
        assertEquals(5, model.maxPlacesForBuyVolume.intValue()); //10.00
        offerBookListItems.addAll(make(OfferBookListItemMaker.btcItem.but(MakeItEasy.with(OfferBookListItemMaker.amount, 22128600000L))));
    ...
    public void testMaxCharactersForSellPrice() {
        ...
        offerBookListItems.addAll(make(OfferBookListItemMaker.btcSellItem.but(MakeItEasy.with(OfferBookListItemMaker.price, 94016475L))));
        assertEquals(9, model.maxPlacesForSellPrice.intValue());
        offerBookListItems.addAll(make(OfferBookListItemMaker.btcSellItem.but(MakeItEasy.with(OfferBookListItemMaker.price, 101016475L))));
    ...
    public void testMaxCharactersForSellVolume() {
        ...
        offerBookListItems.addAll(make(OfferBookListItemMaker.btcSellItem.but(MakeItEasy.with(OfferBookListItemMaker.amount, 100000000L))));
        assertEquals(5, model.maxPlacesForSellVolume.intValue()); //10.00
        offerBookListItems.addAll(make(OfferBookListItemMaker.btcSellItem.but(MakeItEasy.with(OfferBookListItemMaker.amount, 22128600000L))));
