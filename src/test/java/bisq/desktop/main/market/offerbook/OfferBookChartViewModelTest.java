...
public class OfferBookChartViewModelTest {
    ...
    public void testMaxCharactersForBuyVolume() {
        ...
        offerBookListItems.addAll(make(OfferBookListItemMaker.btcItem.but(with(OfferBookListItemMaker.amount, 100000000L))));
        assertEquals(5, model.maxPlacesForBuyVolume.intValue()); //10.00
        offerBookListItems.addAll(make(OfferBookListItemMaker.btcItem.but(with(OfferBookListItemMaker.amount, 22128600000L))));
