...
public class TradeCurrencyMakers {
    ...
    public static final Instantiator<bisq.common.locale.CryptoCurrency> CryptoCurrency = lookup ->
            new CryptoCurrency(lookup.valueOf(currencyCode, "BTC"), lookup.valueOf(currencyName, "Bitcoin"));

    public static final Instantiator<bisq.common.locale.FiatCurrency> FiatCurrency = lookup ->
