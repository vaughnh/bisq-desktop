...
package bisq.gui.main.account.content.fiataccounts;
...
import static bisq.gui.util.FormBuilder.*;



import bisq.gui.common.view.ActivatableViewAndModel;
import bisq.gui.common.view.FxmlView;
import bisq.gui.components.AutoTooltipButton;
import bisq.gui.components.AutoTooltipLabel;
import bisq.gui.components.TitledGroupBg;
import bisq.gui.components.paymentmethods.AliPayForm;
import bisq.gui.components.paymentmethods.CashAppForm;
import bisq.gui.components.paymentmethods.CashDepositForm;
import bisq.gui.components.paymentmethods.ChaseQuickPayForm;
import bisq.gui.components.paymentmethods.ClearXchangeForm;
import bisq.gui.components.paymentmethods.FasterPaymentsForm;
import bisq.gui.components.paymentmethods.InteracETransferForm;
import bisq.gui.components.paymentmethods.MoneyBeamForm;
import bisq.gui.components.paymentmethods.NationalBankForm;
import bisq.gui.components.paymentmethods.OKPayForm;
import bisq.gui.components.paymentmethods.PaymentMethodForm;
import bisq.gui.components.paymentmethods.PerfectMoneyForm;
import bisq.gui.components.paymentmethods.PopmoneyForm;
import bisq.gui.components.paymentmethods.RevolutForm;
import bisq.gui.components.paymentmethods.SameBankForm;
import bisq.gui.components.paymentmethods.SepaForm;
import bisq.gui.components.paymentmethods.SepaInstantForm;
import bisq.gui.components.paymentmethods.SpecificBankForm;
import bisq.gui.components.paymentmethods.SwishForm;
import bisq.gui.components.paymentmethods.USPostalMoneyOrderForm;
import bisq.gui.components.paymentmethods.UpholdForm;
import bisq.gui.components.paymentmethods.VenmoForm;
import bisq.gui.components.paymentmethods.WesternUnionForm;
import bisq.gui.main.overlays.popups.Popup;
import bisq.gui.util.BSFormatter;
import bisq.gui.util.FormBuilder;
import bisq.gui.util.ImageUtil;
import bisq.gui.util.Layout;
import bisq.gui.util.validation.AliPayValidator;
import bisq.gui.util.validation.BICValidator;
import bisq.gui.util.validation.CashAppValidator;
import bisq.gui.util.validation.ChaseQuickPayValidator;
import bisq.gui.util.validation.ClearXchangeValidator;
import bisq.gui.util.validation.IBANValidator;
import bisq.gui.util.validation.InputValidator;
import bisq.gui.util.validation.InteracETransferValidator;
import bisq.gui.util.validation.MoneyBeamValidator;
import bisq.gui.util.validation.OKPayValidator;
import bisq.gui.util.validation.PerfectMoneyValidator;
import bisq.gui.util.validation.PopmoneyValidator;
import bisq.gui.util.validation.RevolutValidator;
import bisq.gui.util.validation.SwishValidator;
import bisq.gui.util.validation.USPostalMoneyOrderValidator;
import bisq.gui.util.validation.UpholdValidator;
import bisq.gui.util.validation.VenmoValidator;
