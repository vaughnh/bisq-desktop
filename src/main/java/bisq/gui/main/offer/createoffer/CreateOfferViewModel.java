...
import bisq.gui.common.model.ActivatableWithDataModel;
import bisq.gui.common.model.ViewModel;
import bisq.gui.main.MainView;
import bisq.gui.main.funds.FundsView;
import bisq.gui.main.funds.deposit.DepositView;
import bisq.gui.main.overlays.popups.Popup;
import bisq.gui.main.settings.SettingsView;
import bisq.gui.main.settings.preferences.PreferencesView;
import bisq.gui.util.BSFormatter;
import bisq.gui.util.BsqFormatter;
import bisq.gui.util.GUIUtil;
import bisq.gui.util.validation.AltcoinValidator;
import bisq.gui.util.validation.BsqValidator;
import bisq.gui.util.validation.BtcValidator;
import bisq.gui.util.validation.FiatPriceValidator;
import bisq.gui.util.validation.FiatVolumeValidator;
import bisq.gui.util.validation.InputValidator;
import bisq.gui.util.validation.MonetaryValidator;
import bisq.gui.util.validation.SecurityDepositValidator;
