...
package bisq.gui.main.offer.takeoffer;
...
import static bisq.gui.util.FormBuilder.addLabelFundsTextfield;
import static bisq.gui.util.FormBuilder.getAmountCurrencyBox;
import static bisq.gui.util.FormBuilder.getNonEditableValueCurrencyBox;
...
import bisq.gui.components.AddressTextField;
import bisq.gui.components.AutoTooltipButton;
import bisq.gui.components.AutoTooltipLabel;
import bisq.gui.components.BalanceTextField;
import bisq.gui.components.BusyAnimation;
import bisq.gui.components.FundsTextField;
import bisq.gui.components.InputTextField;
import bisq.gui.components.TitledGroupBg;
import bisq.gui.main.MainView;
import bisq.gui.main.account.AccountView;
import bisq.gui.main.account.content.arbitratorselection.ArbitratorSelectionView;
import bisq.gui.main.account.settings.AccountSettingsView;
import bisq.gui.main.dao.DaoView;
import bisq.gui.main.dao.wallet.BsqWalletView;
import bisq.gui.main.dao.wallet.receive.BsqReceiveView;
import bisq.gui.main.funds.FundsView;
import bisq.gui.main.funds.withdrawal.WithdrawalView;
import bisq.gui.main.offer.OfferView;
import bisq.gui.main.overlays.notifications.Notification;
import bisq.gui.main.overlays.popups.Popup;
import bisq.gui.main.overlays.windows.FeeOptionWindow;
import bisq.gui.main.overlays.windows.OfferDetailsWindow;
import bisq.gui.main.overlays.windows.QRCodeWindow;
