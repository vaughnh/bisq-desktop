...
public class RequestDisplay {
    ...
    public RequestDisplay(GridPane gridPane, BsqFormatter bsqFormatter, BsqWalletService bsqWalletService, @Nullable FeeService feeService) {
    ...
    public GridPane createCompensationList(TableView<RequestListItem> tableView, String headerString) {
    ...
    public SplitPane createCompensationRequestPane(TableView<RequestListItem> tableView, String headerString) {
    ...
    private void createColumns(TableView<RequestListItem> tableView) {
        TableColumn<RequestListItem, RequestListItem> dateColumn = new AutoTooltipTableColumn<RequestListItem, RequestListItem>(Res.get("shared.dateTime")) {
            {
                setMinWidth(190);
                setMaxWidth(190);
            }
        ...
        dateColumn.setCellFactory(
                new Callback<TableColumn<RequestListItem, RequestListItem>, TableCell<RequestListItem,
                        RequestListItem>>() {
                    @Override
                    public TableCell<RequestListItem, RequestListItem> call(
                            TableColumn<RequestListItem, RequestListItem> column) {
                        return new TableCell<RequestListItem, RequestListItem>() {
                            @Override
                            public void updateItem(final RequestListItem item, boolean empty) {
        ...
        TableColumn<RequestListItem, RequestListItem> nameColumn = new AutoTooltipTableColumn<>(Res.get("shared.name"));
        ...
        TableColumn<RequestListItem, RequestListItem> uidColumn = new AutoTooltipTableColumn<>(Res.get("shared.id"));
        ...
        TableColumn<RequestListItem, RequestListItem> confidenceColumn = new TableColumn<>(Res.get("shared.confirmations"));
        ...
        confidenceColumn.setCellFactory(new Callback<TableColumn<RequestListItem, RequestListItem>,
                TableCell<RequestListItem, RequestListItem>>() {

            @Override
            public TableCell<RequestListItem, RequestListItem> call(TableColumn<RequestListItem,
                    RequestListItem> column) {
                return new TableCell<RequestListItem, RequestListItem>() {
