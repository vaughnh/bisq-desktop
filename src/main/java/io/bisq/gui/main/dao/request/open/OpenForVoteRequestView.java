...
package io.bisq.gui.main.dao.request.open;
...
@FxmlView
public class OpenForVoteRequestView extends BaseRequestView implements BsqBlockChainListener {
    ...
    @Inject
    private OpenForVoteRequestView(CompensationRequestManager compensationRequestManger,
